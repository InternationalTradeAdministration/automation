...
public class TestOne {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String dataPoolPath = InitTools.getInputDataFolder()+"\\datapool\\FTZ_SUBZONE_SITE_FORM.xlsx";
		scenarios = XlsxTools.readXlsxSheetInOrderAndFilter(dataPoolPath, "SubZoneSite", "Active=TRUE");
	...
	*/
	...
	void validate(int i, LinkedHashMap<String, String> row) throws Exception
	{
		...
		if(testCaseStatus)
		testCaseStatus = FTZFormLib.submitFtzSubZoneSite(row);
	}
