...
public class TestOne {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String dataPoolPath = InitTools.getInputDataFolder()+"\\datapool\\FTZ_SUBZONE_OPERATOR_FORM.xlsx";
		scenarios = XlsxTools.readXlsxSheetInOrderAndFilter(dataPoolPath, "SubZoneOperator", "Active=TRUE");
	...
	*/
	...
	void validate(int i, LinkedHashMap<String, String> row) throws Exception
	{
		...
		if (!logged) 
		{
			...
			testCaseStatus = FTZFormLib.createAndSearchZone();
			
		}
		/*if(testCaseStatus)
		testCaseStatus = FTZFormLib.createAndSearchSubZone();*/
		if(testCaseStatus)
		testCaseStatus = FTZFormLib.submitFtzSubZoneOperator(row);
	}
