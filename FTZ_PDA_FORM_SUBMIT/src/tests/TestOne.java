...
public class TestOne {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String dataPoolPath = InitTools.getInputDataFolder()+"\\datapool\\FTZ_PDA_FORM.xlsx";
		scenarios = XlsxTools.readXlsxSheetInOrderAndFilter(dataPoolPath, "PDA", "Active=TRUE");
