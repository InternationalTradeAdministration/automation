...
public class TestOne {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String dataPoolPath = InitTools.getInputDataFolder()+"\\datapool\\FTZ_CORRESPONDENCE_FORM.xlsx";
		scenarios = XlsxTools.readXlsxSheetInOrderAndFilter(dataPoolPath, "Correspondence", "Active=TRUE");
	...
	*/
	...
	void validate(int i, LinkedHashMap<String, String> row) throws Exception
	{
		...
		testCaseStatus = FTZFormLib.submitFtzCorrespondence(row);
	}
