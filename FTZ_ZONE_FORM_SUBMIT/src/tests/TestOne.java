...
public class TestOne {
	...
	public static void main(String[] args) throws Exception 
	{
		...
		String dataPoolPath = InitTools.getInputDataFolder()+"\\datapool\\FTZ_ZONE_FORM.xlsx";
		scenarios = XlsxTools.readXlsxSheetInOrderAndFilter(dataPoolPath, "Zone", "Active=TRUE");
	...
	*/
	...
	void validate(int i, LinkedHashMap<String, String> row) throws Exception
	{
		...
		testCaseStatus = FTZFormLib.submitFtzZone(row);
	}
