...
public class FTZFormLib{
									 ...
									 String password) throws Exception
	{
		...
		}else
		{
			...
			if(checkElementExists(replaceGui(guiMap.get("TopMenu"), "Sign out")))
			{
				...
				clickElementJs(replaceGui(guiMap.get("TopMenu"), "Address") );
			}else
			{
				loginStatus = false;
				setBrowserTimeOut(currentWait);
	 ...
	 * @exception Exception
	*/
	public static boolean submitFtzAddress(HashMap<String, String> row) throws Exception
	{
		...
		updateHtmlReportOverall("Fill up the address form",  "User is able to fill up the form", "As expected", 
		...
		{
			setBrowserTimeOut(currentWait);
			updateHtmlReport("Submit new address form",  "User is able to submit address form", "As expected", 
				"Step", "pass", "create new address form");
		}else
		{
			newForm = false;
			setBrowserTimeOut(currentWait);
			updateHtmlReport("Submit new address form",  "User is able to submit address form", "Not as expected", 
